<%-- 
    Document   : service
    Created on : Oct 8, 2022, 1:54:37 PM
    Author     : dhanu
--%>
...
<html>
    <head>
        ...
        <title>Pheonix Airline PVT - Our Sevices</title>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li><a class="nav-link scrollto active" href="service.jsp">Services</a></li>
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                            <div class="icon-box" >
                                <img src="assets/img/ser1.jpg.crdownload"   class="center">
                        ...
                        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                            <div class="icon-box" data-aos-delay="200">
                                <img src="assets/img/ser4.jpg"   class="center">
                        ...
                        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                            <div class="icon-box"  data-aos-delay="300">
                                <img src="assets/img/ser3.jpg"   class="center">
                                <h4 class="title">Cargo</h4>
                                <p class="description">We also unload, sort and tag export cargo in preparation for loading onto planes, and load it properly to prevent it from falling during a flight.</p>
                            </div>
                        </div>
