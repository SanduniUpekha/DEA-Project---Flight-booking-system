<%-- 
    Document   : viewUser
    Created on : Oct 8, 2022, 11:27:17 AM
    Author     : dhanu
--%>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <%                                    try {
                                            ...
                                            ResultSet resultSet = statement.executeQuery("SELECT * FROM flight_system.user where id = " + id + ";");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="contact_name" placeholder="Name" value="<%=resultSet.getString(2)%>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail3">DOB</label>
                                        <input type="int" class="form-control" id="contact_name" placeholder="Age" value="<%=resultSet.getString(3)%>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail3">Passport Number</label>
                                        <input type="text" class="form-control" id="contact_email" placeholder="NIC" value="<%=resultSet.getInt(6)%>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail3">Email</label>
                                        <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Email" value="<%=resultSet.getString(7)%>" readonly>
                                    </div>
