<%-- 
    Document   : user
    Created on : Oct 8, 2022, 11:10:46 AM
    Author     : dhanu
--%>
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" id="contact" name="userLogin" method="POST" action="../AddUserServlet">
                                        <div class="form-group">
                                            <label for="exampleInputName1">Full Name</label>
                                            <input name="full_name" type="text" class="form-control"  id="contact_name" placeholder="Full Name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Date of birth</label>
                                            <input name="age" type="date" class="form-control" id="contact_name" placeholder="DOB" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Passport Number</label>
                                            <input name="nic" type="text" class="form-control" id="contact_email" placeholder="Passport Number" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="password" type="password" class="form-control" id="psw" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                                        </div>
                        ...
                        <div class="container-lg">
                            <div class="table-responsive">
                                <div class="table-wrapper">
                                    <div class="table-title">
                                        <div class="row">
                                            <div class="col-sm-8"><h2>Current User <b>Details</b></h2></div>
                                            <div class="col-sm-4">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="./viewUser.jsp?id=<%=resultSet.getInt(1)%>">
                            ...
                            <div class="table-responsive">
                                <div class="table-wrapper">
                                    <div class="table-title">
                                        <div class="row">
                                            <div class="col-sm-8"><h2>Blocked User <b>Details</b></h2></div>
                                            <div class="col-sm-4">
