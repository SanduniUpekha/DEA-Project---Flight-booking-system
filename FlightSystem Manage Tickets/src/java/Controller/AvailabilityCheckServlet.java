...
public class AvailabilityCheckServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AvailabilityCheckServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AvailabilityCheckServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        httpSession.setAttribute("ticket_class", ticket_class);
        httpSession.setAttribute("flight_type", flight_type);
        httpSession.setAttribute("day", day);
        httpSession.setAttribute("flight_time", flight_time);
        httpSession.setAttribute("flight_date", flight_date);
        ...
        if (flightManage.checkAvailability(flight) == 0) {
            httpSession.setAttribute("availability", "yes");
