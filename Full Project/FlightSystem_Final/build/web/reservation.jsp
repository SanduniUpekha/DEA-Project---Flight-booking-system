<%-- 
    ...
    Created on : Oct 8, 2022, 1:53:31 PM
    Author     : dhanu
--%>
...
<html>
    <head>
        ...
        <title>Pheonix Airline PVT - Reservation page</title>
    ...
    <body>
                ...
                <section id="contact" class="contact">
                    <div class="container" data-aos="fade-up">
                        ...
                        <div class="section-title">
                            ...
                            <h3><span>Flight Reservation</span></h3>
                                ...
                                <form name="reserve" method="POST" action="./ReserveFlightServlet">
                                    <div class="row">
                                        ...
                                        <div class="col form-group">
                                            ...
                                            <input type="text" name="name" value="<%=firstName%>" class="form-control" id="contact_name" placeholder="Jhon" readonly>
                                        </div>
                                        <div class="col form-group">
                                            <input type="email" class="form-control" name="email" value="<%=lastName%>" id="contact_name" placeholder="David" readonly>
                                        </div>
                                    </div>
                                    <h4>Passport Number</h4>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="subject" id="contact_name" value="<%=resultSet.getInt(6)%>" placeholder="D2309780" readonly>
                                    </div>
                                    <h4>Date of Birth</h4>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="subject" id="contact_name" value="<%=resultSet.getString(3)%>" placeholder="11/14/2018" readonly>
                                    </div>
                                    <h4>Email</h4>
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="subject" id="contact_email" value="<%=resultSet.getString(7)%>" placeholder="example@airlines.com" readonly>
                                    </div>
                                    <h4>Phone number</h4>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="phone" id="contact_name" placeholder="##########" required>
                                    </div>
                                    <h4>Address</h4>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="address" id="contact_name" placeholder="25, james street, colombo 5" required>
                                    </div>

                                    <div class="text-center"><input type="submit" value="Reserve Flight"></div>
                                </form>
                                <% } catch (Exception e) {
        ...
        <footer id="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <p>
                                ...
                                <strong>Email:</strong> spaceland@mail.com<br>
                            </p>
                        </div>
            ...
            <div class="container py-4">
                <div class="copyright">
                    &copy; Copyright <strong><span>SPACELAND</span></strong>. All Rights Reserved
                </div>
                <div class="credits">
