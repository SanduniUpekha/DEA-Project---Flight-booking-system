<%-- 
    ...
    Created on : Oct 8, 2022, 12:50:28 PM
    Author     : dhanu
--%>
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" id="contact" name="update_flight" method="POST" action="../UpdateFlightServlet">
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Flight Id</label>
                                            <input name="id" type="text" class="form-control" id="contact_name" value="<%=flightId%>" placeholder="Shedule ID" readonly >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="flight_date" type="date" class="form-control" id="contact_name" placeholder="Shedule ID" >
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2">Update Flight</button>
                                    </form>
